...
@objc public class DateTimePicker: UIView {
    ...
    @objc open class func show(selected: Date? = nil, minimumDate: Date? = nil, maximumDate: Date? = nil, timeInterval: MinuteInterval = .default) -> DateTimePicker {
        ...
        dateTimePicker.maximumDate = maximumDate ?? Date(timeIntervalSinceNow: 3600 * 24 * 7)
    ...
    private func configureView() {
        ...
        dateTitleLabel.font = UIFont.montserratRegularFont(withSize: 14.0)
        dateTitleLabel.textColor = darkColor
        ...
        cancelButton.titleLabel?.font = UIFont.montserratRegularFont(withSize: 15.0)
        ...
        todayButton.titleLabel?.font = UIFont.montserratRegularFont(withSize: 15.0)
        ...
        doneButton.titleLabel?.font = UIFont.montserratSemiboldFont(withSize: 15.0)
        ...
        colonLabel1.text = ":"
        colonLabel1.font = UIFont.montserratRegularFont(withSize: 14.0)
        colonLabel1.textColor = highlightColor
        ...
        colonLabel2.text = ":"
        colonLabel2.font = UIFont.montserratRegularFont(withSize: 1.0)
        colonLabel2.textColor = highlightColor
...
extension DateTimePicker: UITableViewDataSource, UITableViewDelegate {
    ...
    public func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.textLabel?.font = UIFont.montserratSemiboldFont(withSize: 17.0)
